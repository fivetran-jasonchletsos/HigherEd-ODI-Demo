/*
 * WizardLivePage — dbt-wizard live-build playback for Cascade University.
 *
 ...
 *
 * Aesthetic: dark terminal surface (ivy navy). Fits a 1728x1117 laptop with no page scroll.
...
const STEP_DEFS = [
  ...
  { label: 'Schema Understanding', who: 'Summary',      tools: 'describe, lineage',       insight: '15 cols · 0 null keys' },
...
// Agent accent colors aligned with Cascade palette
  ...
  return (
    <div className="wizard-terminal mx-auto max-w-[1640px] px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <span
            ...
            style={{
              ...
              background: 'rgba(22,101,52,0.1)', color: 'var(--ivy)', border: '1px solid rgba(22,101,52,0.35)',
            }}
          >
            <span
              style={{
          ...
          <span className="font-mono" style={{ color: 'var(--ink-muted)', fontSize: 13 }}>
            Step{' '}
            <span style={{ color: 'var(--ivy)', fontWeight: 700 }}>{currentStep}/{totalSteps}</span>
          ...
          >
            <div
              style={{
                ...
                height: '100%',
                background: complete ? 'var(--good)' : 'var(--ivy)',
      ...
      <div
        ...
        style={{ borderLeftColor: 'var(--ivy)' }}
      >
        <div className="min-w-0 flex-shrink" style={{ flex: '1 1 460px' }}>
          <div className="eyebrow" style={{ fontSize: 10, marginBottom: 2, color: 'var(--ivy)' }}>
            Institutional Research · {scenario.timezone_label} · {scenario.requested_by}
          </div>
          <p
        ...
        <div className="font-mono text-[var(--ink-muted)] shrink-0" style={{ fontSize: 11 }}>
          Target: <span style={{ color: 'var(--ivy)', fontWeight: 700 }}>{scenario.metric_code}</span>
        </div>
      </div>
            ...
            >
              <div
                ...
                style={{
                  ...
                  color: active ? 'var(--ivy)' : done ? 'var(--good)' : 'var(--ink-soft)',
                }}
              >
        ...
        >
          ...
          >
            {visibleNarr.map((m, idx) => {
              ...
              const color = a?.color ?? AGENT_STEP_COLOR[m.e.from] ?? '#166534';
                      ...
                      <div className="flex items-center gap-2 flex-wrap mb-1.5">
                        ...
                        <span
                          ...
                          style={{
                            ...
                            background: 'rgba(22,101,52,0.10)', color: 'var(--ivy)',
        ...
        <section className="flex flex-col gap-3" style={{ height: 'calc(100dvh - 440px)', minHeight: 300 }}>
            ...
            >
              <div className="flex items-center gap-3 flex-wrap min-w-0">
                <div className="eyebrow font-mono" style={{ fontSize: 11, letterSpacing: '0.02em' }}>
                  models/gold/fct_retention_by_school_persona_term.sql
                </div>
                <span
          ...
          <div className="clinical-card flex flex-col" style={{ flex: '1 1 0' }}>
            ...
            >
              <div className="flex items-center gap-3 flex-wrap min-w-0">
                <div className="eyebrow font-mono" style={{ fontSize: 11, letterSpacing: '0.02em' }}>
                  models/gold/fct_retention_by_school_persona_term.yml
                </div>
                <span
                  className="layer-chip"
                  style={{
                    color: '#92400e', background: 'rgba(146,64,14,0.07)',
              ...
              >
                <span
                  style={{
                    ...
                    background: i === 0 ? 'var(--ivy)' : 'var(--ink-soft)',
            ...
            <div className="flex items-baseline gap-3 flex-wrap">
              <div
                ...
                style={{
                  ...
                  background: 'rgba(20,83,45,0.12)', color: 'var(--good)',
      ...
      <style>{`
        ...
        .wizard-terminal::after {
          content: 'cascade-university/wizard-live · dbt-wizard';
          position: absolute;
          top: 0; left: 0; right: 0;
          height: 28px;
          display: flex;
        ...
        .wizard-terminal [style*="color: var(--ivy)"] { color: var(--t-accent) !important; }
        ...
        .wizard-terminal .clinical-card[style*="rgba(22,101,52"] {
          background: rgba(74,222,128,0.10) !important;
        }
        .wizard-terminal .clinical-card[style*="rgba(20,83,45,0.06)"] {
          background: rgba(74,222,128,0.10) !important;
        }
