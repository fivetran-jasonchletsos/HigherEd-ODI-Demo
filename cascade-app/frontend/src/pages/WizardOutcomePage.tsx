    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <header className="mb-10">
        ...
        <p className="mt-3 max-w-3xl leading-relaxed text-lg text-[var(--ink-muted)]">
          ...
          {o.build_seconds} seconds — the same window the Provost waited for an answer.
        </p>
      </header>
      ...
      <section
        ...
        style={{ borderLeft: '5px solid var(--bronze)', background: 'rgba(146,64,14,0.03)' }}
      >
        <div className="eyebrow mb-2 text-[var(--bronze)]">Root cause identified</div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            <div className="eyebrow mb-1">Fallout students</div>
            <div className="font-serif text-3xl font-semibold text-[var(--bronze)]">
          ...
          <div>
            ...
            <div className="font-mono text-sm font-semibold text-[var(--ink-strong)]">
              MATH 220 · Wednesday-evening section · campus work-shift conflict
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-10">
        <LineagePanel
          ...
          subtitle="No gold table tracks retention by school, persona, and term."
      ...
      <section
        ...
        style={{ borderLeft: '5px solid var(--good)', background: 'rgba(20,83,45,0.03)' }}
      >
...
function WizardColumn({ data, tone }: { data: Column; tone: 'crisis' | 'resolved' }) {
  const toneColor =
    tone === 'crisis' ? 'var(--amber)' : 'var(--good)';
  const chipClass =
    tone === 'crisis' ? 'status-pill amber' : 'status-pill ivy';
  return (
    <div
        ...
        {populated.map(layer => (
          <div key={layer}>
            <div
              ...
              style={{ color: NODE_COLOR[layer] ?? '#166534' }}
            >
              {layer}
            </div>
              ...
              {grouped[layer].map(n => {
                ...
                return (
                  <div
                    ...
                    style={{
                      borderLeft: `3px solid ${NODE_COLOR[layer] ?? '#166534'}`,
                      borderColor: 'var(--hairline)',
                      borderLeftColor: NODE_COLOR[layer] ?? '#166534',
                      background: isGap
                        ? 'rgba(190,18,60,0.05)'
                        : isNew
                        ? 'rgba(20,83,45,0.05)'
                  ...
                  >
                    <div className="font-mono text-[11px]" style={{ color: NODE_COLOR[layer] ?? '#166534' }}>
                      {layer}
                    </div>
                    ...
                    {isGap && (
                      <div className="font-mono text-[10px] mt-1 text-[var(--garnet)]">NOT BUILT</div>
                    )}
                    {isNew && (
